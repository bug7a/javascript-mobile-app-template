...
database.getBottomBarItemDataList = function() {
    ...
    const dataList = [
        { pageId: homePage.PAGE_ID, iconFile: "assets/ui-bottom-bar/home.svg", text: "HOME", highLightColor: "#5ABB9F" },
        { pageId: searchPage.PAGE_ID, iconFile: "assets/ui-bottom-bar/search.svg", text: "SEARCH"  },
        { pageId: examplesPage.PAGE_ID, iconFile: "assets/ui-bottom-bar/component.svg", text: "USAGE EXAMPLES", highLightColor: "indianred" },
        { pageId: tasksPage.PAGE_ID, iconFile: "assets/ui-bottom-bar/note.svg", text: "TASKS" },
        { pageId: settingsPage.PAGE_ID, iconFile: "assets/ui-bottom-bar/setting.svg", text: "SETTINGS" }
    ];
