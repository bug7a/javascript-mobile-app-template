...
UITabs.resetDefault = function() {
    ...
    UITabs.default.itemOutterSpace = 1;
...
const createUITabs = function(parameters = {}) {
	...
	for (let parameterName in UITabs.default) {
		box.default[parameterName] = parameters[parameterName] || UITabs.default[parameterName];
	}
    ...
    box.itemDataList = [];
    box.selectedIndex = -1;
    box.totalSpaceX = box.default.itemOutterSpace + box.default.itemOutterSpace + box.default.itemInnerSpaceX + box.default.itemInnerSpaceX;
    ...
    // With motion.
    box.opacity = 0;
    box.setMotion("background-color 0.2s, opacity 0.3s");
    ...
    box.setItemsByDataList = function(dataList) {
        ...
        box.boxSelected.boxBack = createBox(box.default.itemOutterSpace, box.default.itemOutterSpace);
        ...
        box.boxSelected.onResize(function(self) {
            self.boxBack.width = self.width - box.default.itemOutterSpace - box.default.itemOutterSpace;
            self.boxBack.height = self.height - box.default.itemOutterSpace - box.default.itemOutterSpace;
        })
    ...
    box.createItem = function(dataList, index) {
        ...
        item.boxBack = createBox(0, box.default.itemOutterSpace, box.height, item.height - box.default.itemOutterSpace - box.default.itemOutterSpace);
        item.add(that);
        that.color = "transparent";
        that.round = box.default.round;
        ...
        item.lblTitle.onResize(function(self) {
            if (dataList.iconFile) {
                ...
                item.imgIcon.left = box.default.itemOutterSpace + box.default.itemInnerSpaceX;
